...
app.get('/health', asyncRoute(async (_req, res) => {
  ...
  res.json({ status: 'ok', service: 'akiro-api', version: '2.0.0', database: 'connected', timestamp: new Date().toISOString() });
}));
...
const server = app.listen(port, '0.0.0.0', () => console.log(`Akiro API v2 listening on ${port}`));
